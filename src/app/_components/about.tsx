...
export function About(){
    return(
        <section className="bg-[#f8e3c4] py-16 ">
            <div className="container px-4 mx-auto">
                <div className=" grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                    ...
                    <div className="relative" data-aos="fade-up-right" data-aos-delay="300">
                        ...
                        data-aos="fade-up-right" data-aos-delay="50">
                            <Image 
                                src={about2Img}
                                alt="Foto do gato"
                                fill
                    ...
                    <div className="space-y-6 mt-10" data-aos="fade-up-right" data-aos-delay="300">
                        ...
                        <p className="font-semi-bold">Until one has loved an animal, a part of one's soul remains
                        ...
                        <div className="flex gap-2">
                            ...
                            className="bg-green-500 hover:bg-green-600 text-white flex items-center justify-center w-fit
                            gap-2 px-4 py-2 rounded-md">
                                <WhatsappLogo className="w-5 h-5 text-white"/>
                                Contato via Whatsapp
                            </a>
                            <a href="#"
                            className="hover:bg-[#9c9c9c] flex items-center justify-center w-fit
                            gap-2 px-4 py-2 rounded-md">
