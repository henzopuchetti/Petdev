...
export function Services() {
  ...
  return (
    <section className="bg-white py-16">
      <div className="container mx-auto px-4" data-aos="fade-up-right" data-aos-delay="200">

        <h2 className="text-4xl font-bold mb-12 text-center">Serviços</h2>
            ...
            <div className='flex'>
              {services.map((item, index) => (
                <div key={index} className="flex-[0_0_100%] min-w-0 md:flex-[0_0_calc(100%/3)] px-3">
                  <article className="bg-[#a55a05] text-white rounded-2xl p-6 space-y-4 h-full flex flex-col">
